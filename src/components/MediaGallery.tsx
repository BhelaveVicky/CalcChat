...
export const MediaGallery: React.FC = () => {
  ...
  return (
    <div className={`flex-1 flex w-full h-full overflow-hidden select-none relative ${
                  ...
                  <div className="flex items-center justify-around border-b border-[#202c33] pb-2 text-xs">
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-medium transition-all ${
                        activePhotoTool === 'adjust' ? 'bg-[#ff2e93] text-white font-bold' : 'text-gray-300 hover:bg-white/5'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-medium transition-all ${
                        activePhotoTool === 'filter' ? 'bg-[#ff2e93] text-white font-bold' : 'text-gray-300 hover:bg-white/5'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-medium transition-all ${
                        activePhotoTool === 'text' ? 'bg-[#ff2e93] text-white font-bold' : 'text-gray-300 hover:bg-white/5'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-medium transition-all ${
                        activePhotoTool === 'bg' ? 'bg-[#ff2e93] text-white font-bold' : 'text-gray-300 hover:bg-white/5'
                      }`}
                    >
                            ...
                            {[0, 90, 180, 270].map((deg) => (
                              <button
                                ...
                                className={`flex-1 py-1 rounded text-[10px] font-bold transition-colors ${
                                  photoRotation === deg ? 'bg-[#ff2e93] text-white' : 'bg-white/10 text-gray-300 hover:bg-white/20'
                                }`}
                              >
                                {deg}°
                              </button>
                          ...
                          {(['contain', 'cover', 'fill'] as const).map((mode) => (
                            <button
                              ...
                              className={`px-2 py-1 rounded text-[10px] capitalize font-medium ${
                                photoFitMode === mode ? 'bg-[#ff2e93] text-white font-bold' : 'bg-white/10 text-gray-300'
                              }`}
                            >
                              {mode}
                            </button>
                      ...
                      {[
                        ...
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-xl font-medium shrink-0 transition-colors ${
                            selectedFilter === f.id ? 'bg-[#ff2e93] text-white font-bold' : 'bg-white/10 text-gray-200 hover:bg-white/20'
                          }`}
                        >
                          {f.label}
                        </button>
                ...
                <div className={`mt-3 p-3.5 rounded-2xl border space-y-2.5 animate-fade-in ${
                  ...
                  <div className="relative flex items-center">
                    <input
                      ...
                      className={`w-full text-xs px-3 py-2 rounded-xl border text-e9edef focus:outline-none focus:border-[#ff2e93] ${
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={`w-5 h-5 rounded-md border flex items-center justify-center transition-colors shrink-0 ${
                              isChecked ? 'bg-gradient-to-r from-[#ff2e93] to-[#ff60b5] border-[#ff2e93] text-white' : 'border-gray-500'
                            }`}>
