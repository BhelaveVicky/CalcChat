...
export const MessageSelectionToolbar: React.FC<MessageSelectionToolbarProps> = ({
  ...
  return (
    <div className="w-full px-3 py-2.5 bg-gradient-to-r from-pink-600 via-rose-600 to-pink-700 text-white flex items-center justify-between shrink-0 z-30 shadow-lg animate-slide-down border-b border-pink-500/40 font-sans select-none">
